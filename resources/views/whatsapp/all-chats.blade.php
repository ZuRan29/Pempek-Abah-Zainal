    ...
    <div class="container">
        ...
        <div class="right">
            ...
            <div class="chat" data-chat="person2">
                <div style="overflow-y: scroll;" class="chat-demo">
                @foreach ($realchat as $chat)
                    @if ($chat->author == "6285691166309@c.us")
                        <div class="bubble me">
                            @if (substr($chat->body, 0, 5) == "https")
                                <img src="{{$chat->body}}" alt="" width="250px">
                            @else
                                {{$chat->body}}
                            @endif
                        </div>
...
<script type="text/javascript">
    $('.chat-demo').scrollTop($('.chat-demo')[0].scrollHeight);
</script>
